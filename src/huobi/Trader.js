...
let Trader = /** @class */ (() => {
    class Trader {
        ...
        async autoTrader({ symbol, buy_usdt, sell_usdt, period = 5, }, userId) {
            ...
            const data = await this.sdk.getMarketHistoryKline(symbol, huobi_sdk_1.CandlestickIntervalEnum.MIN5, 1500);
            ...
            this.sdk.subMarketKline({ symbol, period: huobi_sdk_1.CandlestickIntervalEnum.MIN5 }, (data) => {

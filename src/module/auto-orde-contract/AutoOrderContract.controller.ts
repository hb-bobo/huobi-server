...
import OrderEntity from './AutoOrderContract.entity';
import * as AutoOrderContractService from './AutoOrderContract.service';
    ...
    public static index = async (ctx: AppContext) => {
        ...
        try {
            ...
            if (id) {
                ...
                res = await AutoOrderContractService.find({});
    ...
    public static updateOne = async (ctx: AppContext) => {
        ...
        try {
            ...
            if (data.id || data._id) {
                ...
                res = await AutoOrderContractService.create(data);
            } else {

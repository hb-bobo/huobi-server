...
exports.getSameAmount = exports.setConfig = void 0;
const getSymbolInfo_1 = require("./getSymbolInfo");
 ...
 */
exports.getSameAmount = function (data, { type = '', symbol = '', sortBy = config.sortBy, priceInfo = { btc: 0, eth: 0 }, } = {}) {
    ...
    for (let key in countTemp) {
        ...
        if ((count > 1 && sumDollar > config.minSumPrice) //机器人
            ...
            let data = {
                count: count,
                amount: utils_1.keepDecimalFixed(key, amountPrecision),
                sumCount: utils_1.keepDecimalFixed(sum, amountPrecision),
                sumMoneny: utils_1.keepDecimalFixed(sumPrice, 2),
                sumDollar: utils_1.keepDecimalFixed(sumDollar, 2),
                price: utils_1.keepDecimalFixed(price, pricePrecision),
